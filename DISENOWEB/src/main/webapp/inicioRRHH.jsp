...
<!--end of Navigation bar-->
    ...
    <div class="container" style="padding-top: 155px">
        ...
        <div class="row">
            <div class="col-md-4">
                <h1 class="text-center">Empleados</h1></div>
            <div class="col-md-4">
                <h1 class="text-center">Proyectos</h1></div>
            <div class="col-md-4">
                <h1 class="text-center">Empresas</h1></div>
        </div>
        <br><br><br>
        <div class="row">
            <div class="col-md-4 d-flex justify-content-center">
               <!-- <a href="mostrarEmpleados.jsp"><span class="fa fa-users" style="font-size:180px;color: #bd043b;text-align:center;"></span></a>-->
            <a href="MainContoller?accion=mostrarEmpleados"><span class="fa fa-users" style="font-size:180px;color: #bd043b;text-align:center;"></span></a>
            </div>
            <div class="col-md-4 d-flex justify-content-center">
               <!-- <a href="mostrarProyectos.jsp"><span class="fa fa-paperclip" style="font-size:180px;color: #bd043b;text-align:center;"></span></a>-->
           <a href="MainContoller?accion=mostrarProyectos"><span class="fa fa-paperclip" style="font-size:180px;color: #bd043b;text-align:center;"></span></a>
            </div>
            <div class="col-md-4 d-flex justify-content-center">
               <!-- <a href="mostrarEmpresas.jsp"><span class="fa fa-building" style="font-size:180px;color: #bd043b;text-align:center;"></span></a>-->
               <a href="MainContoller?accion=mostrarEmpresas"><span class="fa fa-building" style="font-size:180px;color: #bd043b;text-align:center;"></span></a>
            </div>
        </div>
    </div>
</body>
